...
namespace HoloFauna
{
    public static class ThingDefGenerator_Holo
    {
        ...
        {
            List<string> alreadyExistingHolos = new List<string>();
            foreach (PawnKindDef currentKindDef in DefDatabase<PawnKindDef>.AllDefs.ToList<PawnKindDef>())
            {
                ...
                {
                    alreadyExistingHolos.Add(currentKindDef.defName);
                }
            }
            foreach (PawnKindDef currentKindDef in DefDatabase<PawnKindDef>.AllDefs.ToList<PawnKindDef>())
            {
                if (currentKindDef.RaceProps.Animal && !currentKindDef.defName.Contains("HoloFauna_Holo") && !alreadyExistingHolos.Contains("HoloFauna_Holo" + currentKindDef.defName))
                {
