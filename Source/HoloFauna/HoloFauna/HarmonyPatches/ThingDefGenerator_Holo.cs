...
namespace HoloFauna
{
    public static class ThingDefGenerator_Holo
    {
        ...
        {
            foreach (PawnKindDef currentKindDef in DefDatabase<PawnKindDef>.AllDefs)
            {
            ...
            foreach (PawnKindDef currentKindDef in DefDatabase<PawnKindDef>.AllDefs.OrderBy(pawnKindDef => pawnKindDef.defName))
            {
                if (currentKindDef.race.race.Animal && !currentKindDef.defName.Contains("HoloFauna_Holo") && !existingHoloDefs.Contains("HoloFauna_Holo" + currentKindDef.defName))
                {
            ...
            foreach (ThingDef currentThingDef in holoThingDefsToGenerate)
            {
                ...
                holoThingDef.comps.Add(
                    new CompProperties_SolarPowered
                    {
                        ...
                        hoursSurvivableWithoutLight = (72f / currentThingDef.race.baseHealthScale) + 12f,
